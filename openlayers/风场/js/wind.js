...
var MotionDisplay = function(canvas, field, numParticles) {
	this.canvas = canvas;
    this.field = field;
	this.numParticles = numParticles||367.725;
	this.first = true;
...
MotionDisplay.prototype.startMove  = function() {
	...
	// this.numParticles = myView.modalSelect == "gfs"? ($("#windNumParticles").val()/50.0)*(width*height)/(20*Math.pow(zoom,2)):0;
    this.numParticles >=5000? 5000:360;
