...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2818300420696108594L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.proheng.protocol\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"msg\",\"type\":\"string\"}]}");
   ...
   */
  public Message(java.lang.CharSequence id, java.lang.CharSequence msg) {
    this.id = id;
    this.msg = msg;
  }
   ...
   */
  public static com.proheng.protocol.Message.Builder newBuilder() {
    return new com.proheng.protocol.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.proheng.protocol.Message.Builder newBuilder(com.proheng.protocol.Message.Builder other) {
    if (other == null) {
      return new com.proheng.protocol.Message.Builder();
    } else {
      return new com.proheng.protocol.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.proheng.protocol.Message.Builder newBuilder(com.proheng.protocol.Message other) {
    if (other == null) {
      return new com.proheng.protocol.Message.Builder();
    } else {
      return new com.proheng.protocol.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.proheng.protocol.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.proheng.protocol.Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.proheng.protocol.Message.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.proheng.protocol.Message.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.proheng.protocol.Message.Builder setMsg(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.proheng.protocol.Message.Builder clearMsg() {
      msg = null;
